...
# ─────────────────────────────────────────────
    ...
    cols_desc = {
        "employment_type" : "نوع التوظيف: Full Time / Part Time / Internship / Freelance",
        "work_mode"       : "طريقة الشغل: On-site / Remote / Hybrid",
        "experience_level": "مستوى الخبرة - التارجت بتاعنا 🎯",
        "job_category"    : "تصنيف الوظيفة (Accounting / IT / Engineering ...)",
        "exp_years"       : "متوسط سنوات الخبرة المطلوبة (numeric)",
        "city"            : "المدينة المستخرجة من عمود location",
        "country"         : "الدولة",
        "skills_count"    : "عدد الـ skills المطلوبة في الوظيفة",
        "top_skill"       : "أهم skill في الوظيفة",
        "second_skill"    : "ثاني أهم skill"
    }
